                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    	<tr class="odd gradeX">
											...
											<%}else{%>		
											<td><strong><a href="MateriaGradoList?do=listar&grado_list=<%=g.getGrado()%>&grado_turno=<%=g.getTurno()%>&grado_año=<%=año%>" ><i class="fa fa-eye-open"></i> Ver Materias</a></strong></td>
											<%}}}%>
