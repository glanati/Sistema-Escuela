  ...
  <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Cursos <small> Turno tarde</small>
                        </h1>
                        <ol class="breadcrumb">
                        	 <li>
                            ...
                            <li class="active">
                               <i class="fa fa-clock-o"></i> Cursos Turno tarde
                            </li>
                        </ol>
                    </div>
                </div>
				...
				%>
				<br>  	
  				<%Mensaje m = AccionesMensaje.getOne(25);%>
				<!-- MENSAJE INFORMATIVO -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
											...
											<%}else{ %>		
											<td><strong><a href="GradoEdit?do=promocion&grado_modif=<%=g.getGrado()%>&grado_turno=<%=g.getTurno()%>&año=<%=año%>" onclick="<%="return confirm('Esta seguro que desea promocionar "+  g.getGrado() + "-" + g.getTurno()  +"?');"%>">Promocionar</a></strong></td>		
											<% } %>	
