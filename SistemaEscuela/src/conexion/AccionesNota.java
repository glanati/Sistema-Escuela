...
public class AccionesNota {
	...
	public static Notas getNotas(int dni) throws SQLException, Exception {
		
		Statement stmt = Conexion.conectar().createStatement();	
		ResultSet rs = stmt.executeQuery("SELECT * FROM NOTAS WHERE DNI = " + dni);
	...
	public static int deleteNotasDni(int dni) {
		int i = 0;
		try {
			Statement stmt = Conexion.conectar().createStatement();
			i = stmt.executeUpdate("DELETE FROM NOTAS WHERE DNI = " + dni);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return i;
	...
	public static int deleteInformesDni(int dni) {
		int i = 0;
		try {
			Statement stmt = Conexion.conectar().createStatement();
			i = stmt.executeUpdate("DELETE FROM INFORMES WHERE DNI = " + dni);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return i;
	...
	public static Informes getAllInformes( int dni) throws SQLException, Exception {

		Statement stmt = Conexion.conectar().createStatement();
		ResultSet rs = stmt.executeQuery("SELECT * FROM INFORMES WHERE DNI = " + dni );
