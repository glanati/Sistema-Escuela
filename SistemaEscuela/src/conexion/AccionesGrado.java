...
//		}
	...
	public static void insertAlumnoEnGrado(Alumno_Grado ag) throws SQLException, Exception {
		
		Statement stmt = Conexion.conectar().createStatement();		
		stmt.executeUpdate("INSERT INTO ALUMNOS_GRADO VALUES ('" + ag.getGrado() + "','" + ag.getTurno() + "'," + ag.getAño() + "," + ag.getDni() + ")");
...
public static int getCurrentYear(Grado g) {
	...
	stmt.executeUpdate("INSERT INTO ALUMNOS_SUBSIDIO SELECT AÑO+1, DNI, IND_GRUPO, IND_SUBSIDIO FROM ALUMNOS_SUBSIDIO WHERE DNI = " + dni + " AND AÑO = " + (año-1));
